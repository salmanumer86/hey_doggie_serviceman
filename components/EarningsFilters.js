...
import { EARNINGS_FILTER_OPTIONS } from '../constants/bookingConstants';
...
const EarningsFilters = ({ 
  ...
  const hasActiveFilters = () => {
    return filters.serviceType !== 'All' || 
           filters.date !== null ||
    ...
    <View style={[styles.container, style]}>
      <View style={styles.filtersRow}>
        {showServiceType && renderFilterButton(
          'serviceType',
          filters.serviceType,
          EARNINGS_FILTER_OPTIONS.SERVICE_TYPE,
          'paw'
        )}
        ...
        {showDate && renderFilterButton(
          'date',
          filters.date,
          EARNINGS_FILTER_OPTIONS.DATE_RANGE,
          'calendar'
        )}

        {showAmount && renderFilterButton(
          'amountRange',
          filters.amountRange,
          EARNINGS_FILTER_OPTIONS.AMOUNT_RANGE,
          'cash-multiple'
        )}
      </View>
      {hasActiveFilters() && (
